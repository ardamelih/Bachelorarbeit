...
$(window).on('load', function() {
 mData=",loadedPage,Aufgabe1_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)})



$(window).focus(function() {
    mData=  ",switchedBack,Aufgabe1_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)
});

$(window).blur(function() {
mData=  ",switchedWindow,Aufgabe1_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)});
...
function fetchFunction(mData){
	...
	console.log(mData)
    fetch(`${window.origin}/Aufgabe1_geschafft`, {
            method: "POST",
            credentials: "include",
