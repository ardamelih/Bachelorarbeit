...
formElements.push(document.getElementById("HoffestImageBttn"));
...
$(window).on('load', function() {
 mData=",loadedPage,Aufgabenstellung3,"+Date.now()+",,,,,";
    fetchFunction(mData)})

$(window).focus(function() {
    mData=  ",switchedBack,Aufgabenstellung3,"+Date.now()+",,,,,";
    fetchFunction(mData)
});

$(window).blur(function() {
mData=  ",switchedWindow,Aufgabenstellung3,"+Date.now()+",,,,,";
    fetchFunction(mData)});
...
function fetchFunction(mData){
	...
	console.log(mData)
    fetch(`${window.origin}/Aufgabenstellung3`, {
            method: "POST",
            credentials: "include",
