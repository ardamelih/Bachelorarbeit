...
$(window).on('load', function() {
 mData=",loadedPage,Aufgabe2_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)})



$(window).focus(function() {
    mData=  ",switchedBack,Aufgabe2_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)
});


$(window).blur(function() {
mData=  ",switchedWindow,Aufgabe2_geschafft,"+Date.now()+",,,,,";
    fetchFunction(mData)});
...
function fetchFunction(mData){
	...
	console.log(mData)
    fetch(`${window.origin}/Aufgabe2_geschafft`, {
            method: "POST",
            credentials: "include",
